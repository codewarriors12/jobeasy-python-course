...
result_string_1 = print('hello all')
result_string_2 = print("hello there")
name = "dimple"
result_string_3 = print("Hello, %s!" % name)


# Enter a string with your name using console and save the result to result_name variable

result_name = input("what is your name?")
#print(result_name)
